    ...
    function step2() {
        fs.chown('resources/jetsCode.zip',userID,groupID,err => {
            if (err) {
                ...
                console.log("\033[46;37m Succeed \033[0m The owner and group of 'resources/jetsCode.zip' has been changed.\n");
            }
            step3();
        });
    }
    function step3() {
        fs.chown('resources/code.txt',userID,groupID,err => {
            if (err) {
                ...
                console.log("\033[46;37m Succeed \033[0m The owner and group of 'resources/code.txt' has been changed.\n");
            }
            step4();
        });
    }
