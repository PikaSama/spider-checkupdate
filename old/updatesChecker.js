        ...
        axios({
            ...
            .then((data) => {
                fs.writeFile('resources/jetsCode.zip', data, 'binary', (err) =>
                    err ? console.error('\033[41;37m Error \033[0m ' + err + '\n') : chmod(),
                );
            })
...
function gitlove() {
    ...
    axios
        ...
        .then((data) => {
            data = data.split('\n');
            gitDate = data[52].replace(/[^0-9]/gi, '');
    ...
    function downloadHosts() {
        axios
            .get('https://gitee.com/xueweihan/codes/6g793pm2k1hacwfbyesl464/raw?blob_name=GitHub520.yml', {
                responseType: 'arraybuffer',
            })
            .then((resp) => resp.data)
            .then((data) => {
